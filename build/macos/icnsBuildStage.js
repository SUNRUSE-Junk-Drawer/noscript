...
export default class IcnsBuildStage extends WriteFileBuildStage {
  constructor(game, metadata, favicons, createBundleResourcesDirectory) {
    super(
      game,
      `macos/icns`,
      () => [`games`, game.name, `dist`, `macos`, `${metadata.json.applicationName}.app`, `Contents`, `Resources`, `Logo.icns`],
      () => {
        const fragments = []
        let totalBytes = 4
